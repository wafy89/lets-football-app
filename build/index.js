...
async function createUserSession(userId) {
  ...
  return session.set("userId", userId), (0, import_node2.redirect)("/matches", {
    headers: {
...
// app/styles/app.css
var app_default = "/build/_assets/app-RWRQNOTB.css";
  ...
  if (!!matchId)
    switch (actionType) {
      ...
      case "leave":
        ...
        }), (0, import_node3.redirect)("/matches");
      default:
...
var import_jsx_dev_runtime = require("react/jsx-dev-runtime"), action2 = async ({ request }) => {
  ...
  }), (0, import_node4.redirect)(`/matches/${newMatch.id}`);
};
function NewMatch() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, {
    children: [
...
}, badRequest = (data) => (0, import_node6.json)(data, { status: 400 });
function Register() {
...
var badRequest2 = (data) => (0, import_node7.json)(data, { status: 400 }), action5 = async ({ request }) => {
